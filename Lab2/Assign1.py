...
with open("CW1collection/trec.5000.txt") as fp, open("index.txt", "w") as fr, open ("CW1collection/stopwords.txt") as fil:
...
with open("index.txt") as fr,  open("CW1collection/queries.boolean.txt") as fq, open("results.boolean.txt", "w") as fil:
...
with open("index.txt") as fr,  open("CW1collection/queries.ranked.txt") as fq, open("results.ranked.txt", "w") as fil:
